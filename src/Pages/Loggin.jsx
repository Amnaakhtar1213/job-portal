...
const Loggin = () => {
    ...
    <div className=" bg-blue-100 flex flex-col items-center justify-center p-34">
      ...
      <div className="flex flex-col items-center justify-between gap-6 mt-8 border border-blue-200 bg-white rounded-2xl shadow-2xl p-8  shadow-blue-300 hover:shadow-xl hover:shadow-blue-400">
        <div className="flex flex-col gap-2">
          ...
          className="outline-none rounded-2xl border border-blue-300 shadow shadow-blue-300 placeholder:text-sm placeholder:text-gray-300 px-2 py-1 "/>
        </div>
  ...
  <p className="text-red-500 text-sm">
    {error}
        ...
        <button className="bg-blue-700  text-white font-bold px-4 py-1 rounded-xl hover:shadow-xl hover:-translate-y-2 transition-all duration-300 hover:shadow-blue-300" onClick={handleLogin}>Login</button>
