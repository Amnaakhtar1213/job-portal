  ...
  return (
    <div className="bg-gray-200 p-6 md:p-10">
     <div className="flex flex-col items-center justify-center">
       <h1 className="text-blue-700 text-2xl md:text-4xl font-bold">TOP COMPANIES</h1>
      <h2 className="text-gray-800 font-bold text-xl md:text-2xl text-center mt-4">Meet the companies building the future</h2>
      <p className="text-gray-400 mt-2 text-center">Discover organizations trusted by millions
