...
const CompCTA = () => {
  ...
  return (
    <div className="px-8 py-12 bg-indigo-700 rounded-2xl max-w-6xl mx-auto flex flex-col items-center mt-10 mb-10">
      ...
      <button onClick={() => navigate('/jobs')} className="group bg-white text-indigo-700 px-4 py-1 rounded-xl mt-6 hover:shadow-xl hover:shadow-indigo-300 cursor-pointer">Explore Jobs <i className="fa-solid fa-arrow-right ml-2 group-hover:animate-[leftRight_2s_ease-in-out_infinite]"></i></button>
    </div>
  )
}
