...
const Responsibity = ({job}) => {
  return (
       ...
       <div className="max-w-7xl mx-auto bg-white border border-blue-200 rounded-3xl p-8 mt-6 hover:-translate-y-2 transition-all duration-300 shadow-lg shadow-blue-300">
