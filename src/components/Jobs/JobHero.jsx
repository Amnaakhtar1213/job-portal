  ...
  return (
    <div className="pt-10 flex flex-col items-center mt-2">
      ...
      <div className="flex items-center justify-between gap-10 mt-8">
        ...
        type="text" placeholder="Search jobs..." className="relative w-4xl border border-indigo-200 rounded px-8 py-1 hover:border-indigo-300 hover:shadow-indigo-400 hover:shadow focus:outline-none"/> <i className="absolute fa-solid fa-magnifying-glass px-2 text-indigo-500"></i>
