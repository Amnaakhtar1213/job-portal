...
const AboutHead = () => {
  return (
   ...
   forward. </p>
<button className="group bg-purple-700 text-white px-5 py-1 rounded-xl mt-8">Explore Jobs <i className="fa-solid fa-arrow-right ml-2 group-hover:animate-[leftRight_2s_ease-in-out_infinite]"></i></button>
    </div>
  )
}
