...
const AboutHow = () => {
  return (
    <div className="flex flex-col items-center mt-26 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-16 px-4">
       <div className="group bg-indigo-300 text-white flex flex-col items-center justify-center w-full py-10 px-6 rounded-xl border border-gray-300 shadow-xl shadow-gray-400 hover:-translate-y-2 transition-all duration-300">
        ...
        <div className="group bg-indigo-300 text-white flex flex-col items-center justify-center py-10 px-6  rounded-xl border border-gray-300 shadow-xl shadow-gray-400 hover:-translate-y-2 transition-all duration-300">
       ...
       <h1 className="text-2xl group-hover:scale-120 transition-all duration-300 mt-4">📋</h1>
        ...
        <div className="group bg-indigo-300 text-white flex flex-col items-center justify-center w-full px-6 py-10 rounded-xl border border-gray-300 shadow-xl shadow-gray-400 hover:-translate-y-2 transition-all duration-300">
