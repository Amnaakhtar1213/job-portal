...
const AboutHow = () => {
  return (
    <div className="flex flex-col items-center mt-26">
       <h1 className="text-purple-700 text-3xl font-bold text-center"> HOW NEXORA WORKS</h1>

      <div className="flex items-center flex-wrap gap-10 mt-16">
       ...
       <h1 className="text-2xl group-hover:scale-120 transition-all duration-300 mt-4">📋</h1>
        ...
        <div className="group bg-indigo-300 text-white flex flex-col items-center justify-center w-70 px-6 py-4 rounded-xl border border-gray-300 shadow-xl shadow-gray-400">
