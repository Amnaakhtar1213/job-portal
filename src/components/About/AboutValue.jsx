...
const AboutValue = () => {
  return (
    <div className="flex flex-col items-center mt-6">
      ...
      <div className="flex items-center gap-16 mt-18">
        <div className="flex flex-col items-center border border-green-300 rounded-xl w-60 h-60 px-6 py-8 shadow-xl shadow-green-200 hover:scale-110 transition-all duration-300">
        ...
        <div className="flex flex-col items-center border border-indigo-300 rounded-xl w-60 h-60 px-6 py-8 shadow-xl shadow-indigo-300 hover:scale-110 transition-all duration-300">
          <h1 className="text-4xl">🚀 </h1>
        ...
        <div className="flex flex-col items-center border border-purple-300 rounded-xl w-60 h-60 px-6 py-8 shadow-xl shadow-purple-300 hover:scale-110 transition-all duration-300">
          <h1 className="text-4xl">🌍</h1>
         ...
         <div className="flex flex-col items-center border border-blue-300 rounded-xl w-60 h-60 px-6 py-8 shadow-xl shadow-blue-300 hover:scale-110 transition-all duration-300">
          <h1 className="text-4xl">💡</h1>
